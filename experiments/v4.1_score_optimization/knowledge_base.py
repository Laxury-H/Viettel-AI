...
DIAGNOSES = (
    {"aliases": ("thiếu men G6PD", "thiếu hụt men G6PD"), "codes": ("D75.A", "D55.0")},
...
LAB_TEST_PATTERNS = (
    ...
    {"aliases": ("SVO2",)},
    {"aliases": ("CVP",)},
    {"aliases": ("Huyết áp", "HA"), "value_pattern": r"\d{2,3}\s*/\s*\d{2,3}(?:\s*mmhg)?"},
    {"aliases": ("Mạch",), "value_pattern": r"\d+(?:[.,]\d+)?(?:\s*(?:l/?p|lần/?phút|bpm|chu\s*k[ìi]/phút))?"},
    {"aliases": ("Nhiệt độ",), "value_pattern": r"\d+(?:[.,]\d+)?(?:\s*(?:độ\s*c|°\s*c))?"},
    {"aliases": ("Nhịp thở",), "value_pattern": r"\d+(?:[.,]\d+)?(?:\s*(?:l/?p|lần/?phút))?"},
    {"aliases": ("SpO2", "SPO2"), "value_pattern": r"\d+(?:[.,]\d+)?\s*%"},
    {"aliases": ("lipase",)},
    {"aliases": ("ferritin",)},
